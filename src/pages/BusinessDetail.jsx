...
import {
  ...
  LayoutList, TrendingUp, BookOpen, GanttChartSquare, ArrowLeftRight, ListChecks, Check,
} from 'lucide-react';
...
function LightStageStepper({ business, onJump }) {
  return (
...
function LightBusinessDetail({ business }) {
...
export default function BusinessDetail() {
  ...
  if (business.tier === 'leger') return <LightBusinessDetail business={business} />;
