      ...
      <div className="w-full max-w-md">
        ...
        <p className="text-center text-mute mb-8 text-sm">
          {isSupabaseConfigured
            ? 'Your life & trading companion. Sign in to sync your identity across devices.'
            : 'Your life & trading companion. Local-first — everything stays on this machine.'}
        </p>
        {isSupabaseConfigured && <CloudAuthPanel />}
        {isSupabaseConfigured && <div className="text-center text-xs text-mute my-4">or start locally on this device</div>}
