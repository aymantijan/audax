...
import { Target, Trophy, AlertTriangle, CheckCircle2, Clock, Plus, HeartPulse, Wallet, GraduationCap, Megaphone, ChevronRight, Repeat } from 'lucide-react';
...
const DOMAIN_ICONS = { health: HeartPulse, finance: Wallet, learning: GraduationCap, content: Megaphone };
const STATUS = {
  ...
  return (
    <div className="space-y-5 max-w-5xl mx-auto">
      <div>
        ...
        <p className="text-mute text-sm mt-1">Tous vos objectifs au même endroit — santé, argent, études, contenu. Chacun se modifie dans sa section.</p>
      </div>
